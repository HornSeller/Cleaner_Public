...
class WelcomeViewController: UIViewController {
    ...
    private func configure() {
        ...
        for x in 0 ..< 3 {
            ...
            //imageView.image = HomeViewController.onboardingImages[x]
            ...
            let button = UIButton(frame: CGRect(x: 0.159033 * holderView.frame.size.width, y: 1.67939 * holderView.frame.size.width, width: 0.681934 * holderView.frame.size.width, height: 0.11196 * holderView.frame.size.width))
